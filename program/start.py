...
🤖 **[ 𓂄𓆩𝐁𝐑𝐐 𝐌𝐔𝐒𝐈𝐂𓆪𓂁](https://t.me/dddfx1_bot) **
            ...
            [
                [
                    InlineKeyboardButton(
                        "⌯ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐑𝐐⌯",
                        url=f"https://t.me/ektesa7",
                    )
                ],
                [
                    InlineKeyboardButton("⌯ مطوري احمد ⌯", url=f"https://t.me/dddfx0"),
                    InlineKeyboardButton("⌯قناه السورس⌯", url=f"https://t.me/ektesa7"),
                ],
                [InlineKeyboardButton("⌯ سورس ميوزك⌯", url=f"https://t.me/ektesa7")],
...
async def alive(client: Client, message: Message):
    ...
    keyboard = InlineKeyboardMarkup(
            [
               [
                InlineKeyboardButton("• احمد •", url=f"https://t.me/dddfx0"),
                InlineKeyboardButton("• محمد •", url=f"https://t.me/P17_12"),
            ],
                [InlineKeyboardButton("• مطوري احمد•", url=f"https://t.me/dddfx0"),],
                [       
                    InlineKeyboardButton(
                        "⌯ 𓂄𓆩𝐁𝐑𝐐 𝐌𝐔𝐒𝐈𝐂𓆪𓂁 ⌯", url=f"https://t.me/dddfx1_bot"
                    ),
                ],
                [
                    InlineKeyboardButton("⌯ اضافه البوت اللي مجموعتك ⌯", url=f"https://t.me/{BOT_USERNAME}?startgroup=true"),
...
async def help(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/08e0d35187a000659ce3b.jpg",
        caption=f"""**⌯ مطورين سورس برق ميوزك 🎵**""",
        reply_markup=InlineKeyboardMarkup(
         [
            [
                InlineKeyboardButton("𓆩 المطور احمد 𓆪", url=f"https://t.me/dddfx0"),
            ],
            [
                InlineKeyboardButton("𓆩 المطور محمد  𓆪", url=f"https://t.me/P17_12"),
            ],
            [
                InlineKeyboardButton("𓆩 قناة السورس 𓆪", url=f"https://t.me/ektesa7"),
            ],
            [
                InlineKeyboardButton("⌯ اضافه البوت اللي مجموعتك ⌯", url=f"https://t.me/{BOT_USERNAME}?startgroup=true"),
            ]
...
async def start(client: Client, message: Message):
    await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
         [
            [
                InlineKeyboardButton("𓆩 المطور احمد𓆪", url=f"https://t.me/dddfx0"),
                InlineKeyboardButton("𓆩 المطور محمد  𓆪", url=f"https://t.me/P17_12"),
            ],
            [InlineKeyboardButton("𓆩 قناة السورس 𓆪", url=f"https://t.me/ektesa7"),],
            [
