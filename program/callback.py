...
**⌯ انا بوت  استطيع تشغيل الموسيقي والفيديو وحمايه مجموعتك في وقت واحد**
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton("⌯ قناة السورس الاساسية ⌯", url=f"https://t.me/ektesa7"),
                ],
                [InlineKeyboardButton("⌯ ميوزك برق ⌯", url=f"https://t.me/ektesa7")],
...
async def cbguides(_, query: CallbackQuery):
 ...
 ⌯ إذا كانت لديك أسئلة  حول هذا البوت ، فيمكنك إخبارنا من هنا ↤ @Mohmad990754

⌯ قناة سورس برق ميوزك 🎵  @ektesa7
__""",
        reply_markup=InlineKeyboardMarkup(
...
⌯ __قناة سورس برق ميوزك 🎵  @ektesa7  __""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
